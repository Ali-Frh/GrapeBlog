!function(t) {
    ...
    var Q = function t(e) {
      ...
      , V = {
        powered_by: "مدیریت نظرات به کمک Cusdis",
        post_comment: "ارسال نظر",
        loading: "درحال بارگذاری",
        email: "پست الکترونیک (اختیاری)",
        nickname: "نام",
        reply_placeholder: "متن",
        reply_btn: "پاسخ",
        sending: "ارسال نظر...",
        mod_badge: "مدیر",
        content_is_required: "محتوا نمیتواند خالی باشد!",
        nickname_is_required: "بخش نام الزامی است!",
        comment_has_been_sent: "نظر شما با موفقیت دریافت شد و پس از تایید توسط مدیران نمایش داده میشود."
    };
    function W(t) {
